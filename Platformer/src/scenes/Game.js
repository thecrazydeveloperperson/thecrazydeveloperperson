...
class Game extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.spritesheet('hero-idle-sheet', 'assets/platform_gfx/hero/idle.png', {
      frameWidth: 32,
      frameHeight: 64,
    });
    this.load.spritesheet('hero-run-sheet', 'assets/platform_gfx/hero/run.png', {
      frameWidth: 32,
      frameHeight: 64,
      
    });
    this.load.spritesheet('hero-pivot-sheet', 'assets/platform_gfx/hero/pivot.png', {
      frameWidth: 32,
      frameHeight: 64,
    });
    this.load.spritesheet('hero-jump-sheet', 'assets/platform_gfx/hero/jump.png', {
      frameWidth: 32,
      frameHeight: 64,
    });
    this.load.spritesheet('hero-flip-sheet', 'assets/platform_gfx/hero/spinjump.png', {
      frameWidth: 32,
      frameHeight: 64,
    });
    this.load.spritesheet('hero-fall-sheet', 'assets/platform_gfx/hero/fall.png', {
      frameWidth: 32,
      frameHeight: 64,
    });
    this.load.spritesheet('hero-die-sheet', 'assets/platform_gfx/hero/bonk.png', {
      frameWidth: 32,
      frameHeight: 64,
    });
  }
